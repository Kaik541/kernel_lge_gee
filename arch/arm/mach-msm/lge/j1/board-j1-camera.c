...
#endif // CONFIG_IMX091 && CONFIG_MACH_APQ8064_J1D || CONFIG_MACH_APQ8064_J1KD
};
#endif // CONFIG_IMX111 || CONFIG_IMX091 || CONFIG_IMX119
...
#endif // CONFIG_IMX091 || CONFIG_IMX111
...
#ifdef CONFIG_IMX091_ACT
	.actuator_info = &msm_act_main_cam_0_info,
#endif // CONFIG_IMX_091_ACT
	.eeprom_info = &imx091_eeprom_info,
};
#endif // CONFIG_IMX_091
...
static __init void j1_fixup_cam(void)
{
	int ret;
	int gpio_vcm_en;
